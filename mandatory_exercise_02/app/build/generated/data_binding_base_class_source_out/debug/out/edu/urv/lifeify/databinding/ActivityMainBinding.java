...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull EditText edPasswd, @NonNull EditText edUserName, @NonNull ImageView imageView5,
      @NonNull ConstraintLayout main) {
    this.rootView = rootView;
    this.btnLogin = btnLogin;
    this.edPasswd = edPasswd;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.edPasswd;
      EditText edPasswd = ViewBindings.findChildViewById(rootView, id);
      if (edPasswd == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnLogin, edPasswd, edUserName,
          imageView5, main);
    }
